...
import com.example.votogether.log.request.messagebody.MessageBodyReader;
...
public class RequestInfoLogData {
    ...
    public RequestInfoLogData(String id, HttpServletRequest request) {
        ...
        for (final String s : pathVariables.keySet()) {
            System.out.println("PATH VARIABLE = " + s + " VALUE " + pathVariables.get(s));
        }
    }
